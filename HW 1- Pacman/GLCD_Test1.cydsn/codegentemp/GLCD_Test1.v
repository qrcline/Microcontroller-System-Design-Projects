...
module SF_ColorShield_v0_3_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("bd8fb57b-6d52-4287-bc2f-7c6d622e718c/5b4fa1d5-bde1-4eaa-9bf7-891a7546fe82"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("bd8fb57b-6d52-4287-bc2f-7c6d622e718c/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("bd8fb57b-6d52-4287-bc2f-7c6d622e718c/1ece6b3c-a75f-409f-8873-517d71273d40"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("bd8fb57b-6d52-4287-bc2f-7c6d622e718c/688c13a8-e76c-458a-b27f-33e3ab20e917"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("1284014f-f2f2-4ead-8c65-3de44035c677"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e9e7cf8a-7a40-4e59-a108-c7913b532af6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c90a5a03-61c5-4e46-981f-1c381c08251a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("183b3f60-1a69-4083-ab4d-e68752ce9bc6"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("607b09d0-dc3a-4d17-87f5-0ea4fc2b5649"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b50d8085-12d5-4aa8-b9ca-bee39959f26d"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Joy_Center_net;
	wire [0:0] tmpFB_0__Joy_Center_net;
	wire [0:0] tmpIO_0__Joy_Center_net;
	wire [0:0] tmpINTERRUPT_0__Joy_Center_net;
	electrical [0:0] tmpSIOVREF__Joy_Center_net;

	cy_psoc3_pins_v1_10
		#(.id("23691e5f-381f-4209-bf52-dfecdb47d2cc"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Joy_Center
		 (.oe(tmpOE__Joy_Center_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Joy_Center_net[0:0]}),
		  .io({tmpIO_0__Joy_Center_net[0:0]}),
		  .siovref(tmpSIOVREF__Joy_Center_net),
		  .interrupt({tmpINTERRUPT_0__Joy_Center_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Joy_Center_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("d780e7c8-c602-4766-9071-2f57eb554b48"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),

...
#define GLCD_SPIM_SCB_CY_SCBIP_V0    (CYIPBLOCK_m0s8scb_VERSION == 0u)
/* SCB IP block v1 is available in PSoC 4000 */
#define GLCD_SPIM_SCB_CY_SCBIP_V1    (CYIPBLOCK_m0s8scb_VERSION == 1u)
/* SCB IP block v2 is available in all other devices */
#define GLCD_SPIM_SCB_CY_SCBIP_V2    (CYIPBLOCK_m0s8scb_VERSION >= 2u)
...
#define GLCD_SPIM_SCB_SCB_MODE_EZI2C               (0x08u)
...
#define GLCD_SPIM_SCB_SCB_MODE_EZI2C_CONST_CFG     (GLCD_SPIM_SCB_SCB_MODE_EZI2C     == GLCD_SPIM_SCB_SCB_MODE)
...
#define GLCD_SPIM_SCB_SCB_MODE_EZI2C_INC    (0u !=(GLCD_SPIM_SCB_SCB_MODE_EZI2C & GLCD_SPIM_SCB_SCB_MODE))
...
#else
    #define GLCD_SPIM_SCB_SCB_MODE_SPI_INC  (0u)
    #define GLCD_SPIM_SCB_SCB_MODE_UART_INC (0u)
...
#define GLCD_SPIM_SCB_REMOVE_SCB_CLK     (0u)
#define GLCD_SPIM_SCB_SCB_CLK_INTERNAL   (0u == GLCD_SPIM_SCB_REMOVE_SCB_CLK)
...
#if (GLCD_SPIM_SCB_SCB_CLK_INTERNAL)
    #include "GLCD_SPIM_SCB_SCBCLK.h"
#endif /* (GLCD_SPIM_SCB_SCB_CLK_INTERNAL) */
...
*/
    ...
    void GLCD_SPIM_SCB_SetCustomInterruptHandler(void (*func)(void));
...
/* Interface to internal interrupt component */
    ...
    */    
    /*******************************************************************************
    * Function Name: GLCD_SPIM_SCB_EnableInt
    ****************************************************************************//**
    *
    ...
    *
    *******************************************************************************/
    #define GLCD_SPIM_SCB_EnableInt()    CyIntEnable(GLCD_SPIM_SCB_ISR_NUMBER)
    
    
    /*******************************************************************************
    * Function Name: GLCD_SPIM_SCB_DisableInt
    ****************************************************************************//**
    *
    ...
    *
    *******************************************************************************/    
    #define GLCD_SPIM_SCB_DisableInt()   CyIntDisable(GLCD_SPIM_SCB_ISR_NUMBER)
    /** @} interrupt */

    /*******************************************************************************
    * Function Name: GLCD_SPIM_SCB_ClearPendingInt
    ****************************************************************************//**
    *
    *  This function clears the interrupt pending status in the NVIC. 
    *
    *******************************************************************************/
    #define GLCD_SPIM_SCB_ClearPendingInt()  CyIntClearPending(GLCD_SPIM_SCB_ISR_NUMBER)
#endif /* (GLCD_SPIM_SCB_SCB_IRQ_INTERNAL) */

#if (GLCD_SPIM_SCB_UART_RX_WAKEUP_IRQ)
    /*******************************************************************************
    * Function Name: GLCD_SPIM_SCB_RxWakeEnableInt
    ****************************************************************************//**
    *
    *  This function enables the interrupt (RX_WAKE) pending status in the NVIC. 
    *
    *******************************************************************************/    
    #define GLCD_SPIM_SCB_RxWakeEnableInt()  CyIntEnable(GLCD_SPIM_SCB_RX_WAKE_ISR_NUMBER)
    

    /*******************************************************************************
    * Function Name: GLCD_SPIM_SCB_RxWakeDisableInt
    ****************************************************************************//**
    *
    *  This function disables the interrupt (RX_WAKE) pending status in the NVIC.  
    *
    *******************************************************************************/
    #define GLCD_SPIM_SCB_RxWakeDisableInt() CyIntDisable(GLCD_SPIM_SCB_RX_WAKE_ISR_NUMBER)
    
    
    /*******************************************************************************
    * Function Name: GLCD_SPIM_SCB_RxWakeClearPendingInt
    ****************************************************************************//**
    *
    *  This function clears the interrupt (RX_WAKE) pending status in the NVIC. 
    *
    *******************************************************************************/    
    #define GLCD_SPIM_SCB_RxWakeClearPendingInt()  CyIntClearPending(GLCD_SPIM_SCB_RX_WAKE_ISR_NUMBER)
...
/* Get interrupt cause */
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_GetInterruptCause
****************************************************************************//**
*
...
*    - GLCD_SPIM_SCB_INTR_CAUSE_MASTER - Interrupt from Master
*    - GLCD_SPIM_SCB_INTR_CAUSE_SLAVE - Interrupt from Slave
*    - GLCD_SPIM_SCB_INTR_CAUSE_TX - Interrupt from TX
*    - GLCD_SPIM_SCB_INTR_CAUSE_RX - Interrupt from RX
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_GetRxInterruptSource
****************************************************************************//**
*
...
*   - GLCD_SPIM_SCB_INTR_RX_FIFO_LEVEL - The number of data elements in the 
      RX FIFO is greater than the value of RX FIFO level.
*   - GLCD_SPIM_SCB_INTR_RX_NOT_EMPTY - Receiver FIFO is not empty.
*   - GLCD_SPIM_SCB_INTR_RX_FULL - Receiver FIFO is full.
*   - GLCD_SPIM_SCB_INTR_RX_OVERFLOW - Attempt to write to a full 
*     receiver FIFO.
*   - GLCD_SPIM_SCB_INTR_RX_UNDERFLOW - Attempt to read from an empty 
*     receiver FIFO.
*   - GLCD_SPIM_SCB_INTR_RX_FRAME_ERROR - UART framing error detected.
*   - GLCD_SPIM_SCB_INTR_RX_PARITY_ERROR - UART parity error detected.
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_SetRxInterruptMode
****************************************************************************//**
*
...
*   GLCD_SPIM_SCB_GetRxInterruptSource() function for bit fields values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_GetRxInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_GetRxInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_ClearRxInterruptSource
****************************************************************************//**
*
...
*   - GLCD_SPIM_SCB_INTR_RX_FIFO_LEVEL Interrupt source is not cleared when 
*     the receiver FIFO has more entries than level.
*   - GLCD_SPIM_SCB_INTR_RX_NOT_EMPTY Interrupt source is not cleared when
*     receiver FIFO is not empty.
*   - GLCD_SPIM_SCB_INTR_RX_FULL Interrupt source is not cleared when 
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_SetRxInterrupt
****************************************************************************//**
*
...
*   register (refer to GLCD_SPIM_SCB_GetRxInterruptSource() function for bit 
*   fields values).
*
*******************************************************************************/
#define GLCD_SPIM_SCB_SetRxInterrupt(interruptMask)  GLCD_SPIM_SCB_SET_INTR_RX(interruptMask)

void GLCD_SPIM_SCB_SetRxFifoLevel(uint32 level);


/* APIs to service INTR_TX register */
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_GetTxInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - GLCD_SPIM_SCB_INTR_TX_FIFO_LEVEL - The number of data elements in the 
*     TX FIFO is less than the value of TX FIFO level.
*   - GLCD_SPIM_SCB_INTR_TX_NOT_FULL - Transmitter FIFO is not full.
*   - GLCD_SPIM_SCB_INTR_TX_EMPTY - Transmitter FIFO is empty.
*   - GLCD_SPIM_SCB_INTR_TX_OVERFLOW - Attempt to write to a full 
*     transmitter FIFO.
*   - GLCD_SPIM_SCB_INTR_TX_UNDERFLOW - Attempt to read from an empty 
*     transmitter FIFO.
*   - GLCD_SPIM_SCB_INTR_TX_UART_NACK - UART received a NACK in SmartCard 
*   mode.
*   - GLCD_SPIM_SCB_INTR_TX_UART_DONE - UART transfer is complete. 
*     All data elements from the TX FIFO are sent.
*   - GLCD_SPIM_SCB_INTR_TX_UART_ARB_LOST - Value on the TX line of the UART
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_SetTxInterruptMode
****************************************************************************//**
*
...
*   GLCD_SPIM_SCB_GetTxInterruptSource() function for bit field values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_GetTxInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_GetTxInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_ClearTxInterruptSource
****************************************************************************//**
*
...
*   - GLCD_SPIM_SCB_INTR_TX_FIFO_LEVEL - Interrupt source is not cleared when 
*     transmitter FIFO has less entries than level.
*   - GLCD_SPIM_SCB_INTR_TX_NOT_FULL - Interrupt source is not cleared when
*     transmitter FIFO has empty entries.
*   - GLCD_SPIM_SCB_INTR_TX_EMPTY - Interrupt source is not cleared when 
*     transmitter FIFO is empty.
*   - GLCD_SPIM_SCB_INTR_TX_UNDERFLOW - Interrupt source is not cleared when 
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_SetTxInterrupt
****************************************************************************//**
*
*  Sets RX interrupt sources in the interrupt request register.
*
...
void GLCD_SPIM_SCB_SetTxFifoLevel(uint32 level);


/* APIs to service INTR_MASTER register */
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_GetMasterInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - GLCD_SPIM_SCB_INTR_MASTER_SPI_DONE - SPI master transfer is complete.
*     Refer to Interrupt sources section for detailed description.
*   - GLCD_SPIM_SCB_INTR_MASTER_I2C_ARB_LOST - I2C master lost arbitration.
*   - GLCD_SPIM_SCB_INTR_MASTER_I2C_NACK - I2C master received negative 
*    acknowledgement (NAK).
*   - GLCD_SPIM_SCB_INTR_MASTER_I2C_ACK - I2C master received acknowledgement.
*   - GLCD_SPIM_SCB_INTR_MASTER_I2C_STOP - I2C master generated STOP.
*   - GLCD_SPIM_SCB_INTR_MASTER_I2C_BUS_ERROR - I2C master bus error 
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_SetMasterInterruptMode
****************************************************************************//**
*
...
*   GLCD_SPIM_SCB_GetMasterInterruptSource() function for bit field values).
*
*******************************************************************************/
#define GLCD_SPIM_SCB_SetMasterInterruptMode(interruptMask)  GLCD_SPIM_SCB_WRITE_INTR_MASTER_MASK(interruptMask)

/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_GetMasterInterruptMode
****************************************************************************//**
*
...
*   GLCD_SPIM_SCB_GetMasterInterruptSource() function for return values).
*
*******************************************************************************/
#define GLCD_SPIM_SCB_GetMasterInterruptMode()   (GLCD_SPIM_SCB_INTR_MASTER_MASK_REG)

/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_GetMasterInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_ClearMasterInterruptSource
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_SetMasterInterrupt
****************************************************************************//**
*
*  Sets Master interrupt sources in the interrupt request register.
*
*  \param interruptMask: Master interrupt sources to set in the Master interrupt
*   request register (refer to GLCD_SPIM_SCB_GetMasterInterruptSource() 
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_GetSlaveInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - GLCD_SPIM_SCB_INTR_SLAVE_I2C_ARB_LOST - I2C slave lost arbitration: 
*     the value driven on the SDA line is not the same as the value observed 
*     on the SDA line.
*   - GLCD_SPIM_SCB_INTR_SLAVE_I2C_NACK - I2C slave received negative 
*     acknowledgement (NAK).
*   - GLCD_SPIM_SCB_INTR_SLAVE_I2C_ACK - I2C slave received 
*     acknowledgement (ACK).
*   - GLCD_SPIM_SCB_INTR_SLAVE_I2C_WRITE_STOP - Stop or Repeated Start 
*     event for write transfer intended for this slave (address matching 
*     is performed).
*   - GLCD_SPIM_SCB_INTR_SLAVE_I2C_STOP - Stop or Repeated Start event 
*     for (read or write) transfer intended for this slave (address matching 
*     is performed).
*   - GLCD_SPIM_SCB_INTR_SLAVE_I2C_START - I2C slave received Start 
*     condition.
*   - GLCD_SPIM_SCB_INTR_SLAVE_I2C_ADDR_MATCH - I2C slave received matching 
*     address.
*   - GLCD_SPIM_SCB_INTR_SLAVE_I2C_GENERAL - I2C Slave received general 
*     call address.
*   - GLCD_SPIM_SCB_INTR_SLAVE_I2C_BUS_ERROR - I2C slave bus error (detection 
*      of unexpected Start or Stop condition).
*   - GLCD_SPIM_SCB_INTR_SLAVE_SPI_BUS_ERROR - SPI slave select line is 
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_SetSlaveInterruptMode
****************************************************************************//**
*
...
*   GLCD_SPIM_SCB_GetSlaveInterruptSource() function for bit field values).
*
*******************************************************************************/
#define GLCD_SPIM_SCB_SetSlaveInterruptMode(interruptMask)   GLCD_SPIM_SCB_WRITE_INTR_SLAVE_MASK(interruptMask)

/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_GetSlaveInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_GetSlaveInterruptSourceMasked
****************************************************************************//**
*
...
*   GLCD_SPIM_SCB_GetSlaveInterruptSource() function for return values).
*
*******************************************************************************/
#define GLCD_SPIM_SCB_GetSlaveInterruptSourceMasked()    (GLCD_SPIM_SCB_INTR_SLAVE_MASKED_REG)

/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_ClearSlaveInterruptSource
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_SetSlaveInterrupt
****************************************************************************//**
*
*  Sets Slave interrupt sources in the interrupt request register.
*
*  \param interruptMask: Slave interrupt sources to set in the Slave interrupt 
*   request register (refer to GLCD_SPIM_SCB_GetSlaveInterruptSource() 
...
/** GLCD_SPIM_SCB_initVar indicates whether the GLCD_SPIM_SCB 
*  component has been initialized. The variable is initialized to 0 
*  and set to 1 the first time SCB_Start() is called. This allows 
*  the component to restart without reinitialization after the first 
*  call to the GLCD_SPIM_SCB_Start() routine.
*
*  If re-initialization of the component is required, then the 
*  GLCD_SPIM_SCB_Init() function can be called before the 
*  GLCD_SPIM_SCB_Start() or GLCD_SPIM_SCB_Enable() function.
*/
...
#define GLCD_SPIM_SCB_STATUS_PTR             ( (reg32 *) GLCD_SPIM_SCB_SCB__STATUS)
    ...
    #define GLCD_SPIM_SCB_UART_TX_CTRL_PTR       ( (reg32 *) GLCD_SPIM_SCB_SCB__UART_TX_CTRL)
    ...
    #define GLCD_SPIM_SCB_UART_FLOW_CTRL_REG     (*(reg32 *) GLCD_SPIM_SCB_SCB__UART_FLOW_CTRL)
    #define GLCD_SPIM_SCB_UART_FLOW_CTRL_PTR     ( (reg32 *) GLCD_SPIM_SCB_SCB__UART_FLOW_CTRL)
...
#ifdef GLCD_SPIM_SCB_SCB__EZ_DATA0
    #define GLCD_SPIM_SCB_EZBUF_DATA0_REG    (*(reg32 *) GLCD_SPIM_SCB_SCB__EZ_DATA0)
    #define GLCD_SPIM_SCB_EZBUF_DATA0_PTR    ( (reg32 *) GLCD_SPIM_SCB_SCB__EZ_DATA0)
#else
    #define GLCD_SPIM_SCB_EZBUF_DATA0_REG    (*(reg32 *) GLCD_SPIM_SCB_SCB__EZ_DATA00)
    #define GLCD_SPIM_SCB_EZBUF_DATA0_PTR    ( (reg32 *) GLCD_SPIM_SCB_SCB__EZ_DATA00)
#endif /* GLCD_SPIM_SCB_SCB__EZ_DATA00 */
...
#define GLCD_SPIM_SCB_FIFO_SIZE      (8u)  /* TX or RX FIFO size. */
#define GLCD_SPIM_SCB_EZ_DATA_NR     (32u)  /* Number of words in EZ memory. */ 
#define GLCD_SPIM_SCB_ONE_BYTE_WIDTH (8u)            /* Number of bits in one byte. */
#define GLCD_SPIM_SCB_FF_DATA_NR_LOG2_MASK       (0x07u)      /* Number of bits to represent a FIFO address. */
#define GLCD_SPIM_SCB_FF_DATA_NR_LOG2_PLUS1_MASK (0x0Fu) /* Number of bits to represent #bytes in FIFO. */
...
#if (GLCD_SPIM_SCB_SCB_IRQ_INTERNAL)
    #define GLCD_SPIM_SCB_ISR_NUMBER     ((uint8) GLCD_SPIM_SCB_SCB_IRQ__INTC_NUMBER)
    #define GLCD_SPIM_SCB_ISR_PRIORITY   ((uint8) GLCD_SPIM_SCB_SCB_IRQ__INTC_PRIOR_NUM)
#endif /* (GLCD_SPIM_SCB_SCB_IRQ_INTERNAL) */

#if (GLCD_SPIM_SCB_UART_RX_WAKEUP_IRQ)
    #define GLCD_SPIM_SCB_RX_WAKE_ISR_NUMBER     ((uint8) GLCD_SPIM_SCB_RX_WAKEUP_IRQ__INTC_NUMBER)
    #define GLCD_SPIM_SCB_RX_WAKE_ISR_PRIORITY   ((uint8) GLCD_SPIM_SCB_RX_WAKEUP_IRQ__INTC_PRIOR_NUM)
#endif /* (GLCD_SPIM_SCB_UART_RX_WAKEUP_IRQ) */

/* GLCD_SPIM_SCB_CTRL_REG */
...
#if !(GLCD_SPIM_SCB_CY_SCBIP_V0 || GLCD_SPIM_SCB_CY_SCBIP_V1)
    #define GLCD_SPIM_SCB_CTRL_BYTE_MODE_POS (11u) /* [11]    Determines the number of bits per FIFO data element */
#endif /* !(GLCD_SPIM_SCB_CY_SCBIP_V0 || GLCD_SPIM_SCB_CY_SCBIP_V1) */
#define GLCD_SPIM_SCB_CTRL_ADDR_ACCEPT_POS   (16u) /* [16]    Put matched address in RX FIFO       */
#define GLCD_SPIM_SCB_CTRL_BLOCK_POS         (17u) /* [17]    Ext and Int logic to resolve collide */
...
#define GLCD_SPIM_SCB_CTRL_EC_AM_MODE        ((uint32) 0x01u << GLCD_SPIM_SCB_CTRL_EC_AM_MODE_POS)
#define GLCD_SPIM_SCB_CTRL_EC_OP_MODE        ((uint32) 0x01u << GLCD_SPIM_SCB_CTRL_EC_OP_MODE_POS)
#define GLCD_SPIM_SCB_CTRL_EZBUF_MODE        ((uint32) 0x01u << GLCD_SPIM_SCB_CTRL_EZBUF_MODE_POS)
#if !(GLCD_SPIM_SCB_CY_SCBIP_V0 || GLCD_SPIM_SCB_CY_SCBIP_V1)
    #define GLCD_SPIM_SCB_CTRL_BYTE_MODE ((uint32) 0x01u << GLCD_SPIM_SCB_CTRL_BYTE_MODE_POS)
#endif /* !(GLCD_SPIM_SCB_CY_SCBIP_V0 || GLCD_SPIM_SCB_CY_SCBIP_V1) */
#define GLCD_SPIM_SCB_CTRL_ADDR_ACCEPT       ((uint32) 0x01u << GLCD_SPIM_SCB_CTRL_ADDR_ACCEPT_POS)
#define GLCD_SPIM_SCB_CTRL_BLOCK             ((uint32) 0x01u << GLCD_SPIM_SCB_CTRL_BLOCK_POS)
#define GLCD_SPIM_SCB_CTRL_MODE_MASK         ((uint32) 0x03u << GLCD_SPIM_SCB_CTRL_MODE_POS)
#define GLCD_SPIM_SCB_CTRL_MODE_I2C          ((uint32) 0x00u)
#define GLCD_SPIM_SCB_CTRL_MODE_SPI          ((uint32) 0x01u << GLCD_SPIM_SCB_CTRL_MODE_POS)
#define GLCD_SPIM_SCB_CTRL_MODE_UART         ((uint32) 0x02u << GLCD_SPIM_SCB_CTRL_MODE_POS)
#define GLCD_SPIM_SCB_CTRL_ENABLED           ((uint32) 0x01u << GLCD_SPIM_SCB_CTRL_ENABLED_POS)

/* GLCD_SPIM_SCB_STATUS_REG */
#define GLCD_SPIM_SCB_STATUS_EC_BUSY_POS     (0u)  /* [0] Bus busy. Externally clocked logic access to EZ memory */
...
#if !(GLCD_SPIM_SCB_CY_SCBIP_V0 || GLCD_SPIM_SCB_CY_SCBIP_V1)
    #define GLCD_SPIM_SCB_SPI_CTRL_SCLK_CONTINUOUS_POS   (5u)  /* [5]     Enable continuous SCLK generation */
    #define GLCD_SPIM_SCB_SPI_CTRL_SSEL0_POLARITY_POS    (8u)  /* [8]     SS0 polarity                      */
    #define GLCD_SPIM_SCB_SPI_CTRL_SSEL1_POLARITY_POS    (9u)  /* [9]     SS1 polarity                      */
    #define GLCD_SPIM_SCB_SPI_CTRL_SSEL2_POLARITY_POS    (10u) /* [10]    SS2 polarity                      */
    #define GLCD_SPIM_SCB_SPI_CTRL_SSEL3_POLARITY_POS    (11u) /* [11]    SS3 polarity                      */
#endif /* !(GLCD_SPIM_SCB_CY_SCBIP_V0 || GLCD_SPIM_SCB_CY_SCBIP_V1) */
#define GLCD_SPIM_SCB_SPI_CTRL_LOOPBACK_POS          (16u) /* [16]    Local loop-back control enabled            */
...
#define GLCD_SPIM_SCB_SPI_CTRL_SELECT_PRECEDE        ((uint32) 0x01u << GLCD_SPIM_SCB_SPI_CTRL_SELECT_PRECEDE_POS)
#define GLCD_SPIM_SCB_SPI_CTRL_SCLK_MODE_MASK        ((uint32) 0x03u << GLCD_SPIM_SCB_SPI_CTRL_CPHA_POS)
#define GLCD_SPIM_SCB_SPI_CTRL_CPHA                  ((uint32) 0x01u << GLCD_SPIM_SCB_SPI_CTRL_CPHA_POS)
#define GLCD_SPIM_SCB_SPI_CTRL_CPOL                  ((uint32) 0x01u << GLCD_SPIM_SCB_SPI_CTRL_CPOL_POS)
#define GLCD_SPIM_SCB_SPI_CTRL_LATE_MISO_SAMPLE      ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_SPI_CTRL_LATE_MISO_SAMPLE_POS)
#if !(GLCD_SPIM_SCB_CY_SCBIP_V0 || GLCD_SPIM_SCB_CY_SCBIP_V1)
    #define GLCD_SPIM_SCB_SPI_CTRL_SCLK_CONTINUOUS  ((uint32) 0x01u << GLCD_SPIM_SCB_SPI_CTRL_SCLK_CONTINUOUS_POS)
    #define GLCD_SPIM_SCB_SPI_CTRL_SSEL0_POLARITY   ((uint32) 0x01u << GLCD_SPIM_SCB_SPI_CTRL_SSEL0_POLARITY_POS)
    #define GLCD_SPIM_SCB_SPI_CTRL_SSEL1_POLARITY   ((uint32) 0x01u << GLCD_SPIM_SCB_SPI_CTRL_SSEL1_POLARITY_POS)
    #define GLCD_SPIM_SCB_SPI_CTRL_SSEL2_POLARITY   ((uint32) 0x01u << GLCD_SPIM_SCB_SPI_CTRL_SSEL2_POLARITY_POS)
    #define GLCD_SPIM_SCB_SPI_CTRL_SSEL3_POLARITY   ((uint32) 0x01u << GLCD_SPIM_SCB_SPI_CTRL_SSEL3_POLARITY_POS)
    #define GLCD_SPIM_SCB_SPI_CTRL_SSEL_POLARITY_MASK ((uint32)0x0Fu << GLCD_SPIM_SCB_SPI_CTRL_SSEL0_POLARITY_POS)
#endif /* !(GLCD_SPIM_SCB_CY_SCBIP_V0 || GLCD_SPIM_SCB_CY_SCBIP_V1) */

#define GLCD_SPIM_SCB_SPI_CTRL_LOOPBACK              ((uint32) 0x01u << GLCD_SPIM_SCB_SPI_CTRL_LOOPBACK_POS)
#define GLCD_SPIM_SCB_SPI_CTRL_MODE_MASK             ((uint32) 0x03u << GLCD_SPIM_SCB_SPI_CTRL_MODE_POS)
#define GLCD_SPIM_SCB_SPI_CTRL_MODE_MOTOROLA         ((uint32) 0x00u)
#define GLCD_SPIM_SCB_SPI_CTRL_MODE_TI               ((uint32) 0x01u << GLCD_SPIM_SCB_CTRL_MODE_POS)
#define GLCD_SPIM_SCB_SPI_CTRL_MODE_NS               ((uint32) 0x02u << GLCD_SPIM_SCB_CTRL_MODE_POS)
#define GLCD_SPIM_SCB_SPI_CTRL_SLAVE_SELECT_MASK     ((uint32) 0x03u << GLCD_SPIM_SCB_SPI_CTRL_SLAVE_SELECT_POS)
#define GLCD_SPIM_SCB_SPI_CTRL_SLAVE_SELECT0         ((uint32) 0x00u)
#define GLCD_SPIM_SCB_SPI_CTRL_SLAVE_SELECT1         ((uint32) 0x01u << GLCD_SPIM_SCB_SPI_CTRL_SLAVE_SELECT_POS)
#define GLCD_SPIM_SCB_SPI_CTRL_SLAVE_SELECT2         ((uint32) 0x02u << GLCD_SPIM_SCB_SPI_CTRL_SLAVE_SELECT_POS)
#define GLCD_SPIM_SCB_SPI_CTRL_SLAVE_SELECT3         ((uint32) 0x03u << GLCD_SPIM_SCB_SPI_CTRL_SLAVE_SELECT_POS)
#define GLCD_SPIM_SCB_SPI_CTRL_MASTER                ((uint32) 0x01u << GLCD_SPIM_SCB_SPI_CTRL_MASTER_MODE_POS)
...
#define GLCD_SPIM_SCB_SPI_STATUS_EZBUF_ADDR_MASK ((uint32) 0xFFu << GLCD_SPIM_SCB_I2C_STATUS_EZBUF_ADDR_POS)

/* GLCD_SPIM_SCB_UART_CTRL */
#define GLCD_SPIM_SCB_UART_CTRL_LOOPBACK_POS         (16u) /* [16] Loop-back    */
#define GLCD_SPIM_SCB_UART_CTRL_MODE_POS             (24u) /* [24] UART subMode */
#define GLCD_SPIM_SCB_UART_CTRL_LOOPBACK             ((uint32) 0x01u << GLCD_SPIM_SCB_UART_CTRL_LOOPBACK_POS)
#define GLCD_SPIM_SCB_UART_CTRL_MODE_UART_STD        ((uint32) 0x00u)
#define GLCD_SPIM_SCB_UART_CTRL_MODE_UART_SMARTCARD  ((uint32) 0x01u << GLCD_SPIM_SCB_UART_CTRL_MODE_POS)
#define GLCD_SPIM_SCB_UART_CTRL_MODE_UART_IRDA       ((uint32) 0x02u << GLCD_SPIM_SCB_UART_CTRL_MODE_POS)
#define GLCD_SPIM_SCB_UART_CTRL_MODE_MASK            ((uint32) 0x03u << GLCD_SPIM_SCB_UART_CTRL_MODE_POS)
...
#define GLCD_SPIM_SCB_UART_TX_CTRL_PARITY                ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_UART_TX_CTRL_PARITY_POS)
#define GLCD_SPIM_SCB_UART_TX_CTRL_PARITY_ENABLED        ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_UART_TX_CTRL_PARITY_ENABLED_POS)
#define GLCD_SPIM_SCB_UART_TX_CTRL_RETRY_ON_NACK         ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_UART_TX_CTRL_RETRY_ON_NACK_POS)

/* GLCD_SPIM_SCB_UART_RX_CTRL */
#define GLCD_SPIM_SCB_UART_RX_CTRL_STOP_BITS_POS             (0u)  /* [2:0] Stop bits: (Stop bits + 1) * 0.5 period*/
...
#define GLCD_SPIM_SCB_UART_RX_CTRL_LIN_MODE_POS              (12u) /* [12]  Lin mode: applicable for UART Standard */
#define GLCD_SPIM_SCB_UART_RX_CTRL_SKIP_START_POS            (13u) /* [13]  Skip start not: only for UART Standard */
...
#define GLCD_SPIM_SCB_UART_RX_CTRL_PARITY                    ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_UART_RX_CTRL_PARITY_POS)
#define GLCD_SPIM_SCB_UART_RX_CTRL_PARITY_ENABLED            ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_UART_RX_CTRL_PARITY_ENABLED_POS)
#define GLCD_SPIM_SCB_UART_RX_CTRL_POLARITY                  ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_UART_RX_CTRL_POLARITY_POS)
#define GLCD_SPIM_SCB_UART_RX_CTRL_DROP_ON_PARITY_ERR        ((uint32) 0x01u << \
                                                                   GLCD_SPIM_SCB_UART_RX_CTRL_DROP_ON_PARITY_ERR_POS)
#define GLCD_SPIM_SCB_UART_RX_CTRL_DROP_ON_FRAME_ERR         ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_UART_RX_CTRL_DROP_ON_FRAME_ERR_POS)
#define GLCD_SPIM_SCB_UART_RX_CTRL_MP_MODE                   ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_UART_RX_CTRL_MP_MODE_POS)
#define GLCD_SPIM_SCB_UART_RX_CTRL_LIN_MODE                  ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_UART_RX_CTRL_LIN_MODE_POS)
#define GLCD_SPIM_SCB_UART_RX_CTRL_SKIP_START                ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_UART_RX_CTRL_SKIP_START_POS)
#define GLCD_SPIM_SCB_UART_RX_CTRL_BREAK_WIDTH_MASK          ((uint32) 0x0Fu << \
                                                                    GLCD_SPIM_SCB_UART_RX_CTRL_BREAK_WIDTH_POS)
/* GLCD_SPIM_SCB_UART_RX_STATUS_REG */
#define GLCD_SPIM_SCB_UART_RX_STATUS_BR_COUNTER_POS     (0u)  /* [11:0] Baud Rate counter */
#define GLCD_SPIM_SCB_UART_RX_STATUS_BR_COUNTER_MASK    ((uint32) 0xFFFu)

#if !(GLCD_SPIM_SCB_CY_SCBIP_V0 || GLCD_SPIM_SCB_CY_SCBIP_V1)
    /* GLCD_SPIM_SCB_UART_FLOW_CTRL_REG */
    #define GLCD_SPIM_SCB_UART_FLOW_CTRL_TRIGGER_LEVEL_POS    (0u)  /* [7:0] RTS RX FIFO trigger level         */
    #define GLCD_SPIM_SCB_UART_FLOW_CTRL_RTS_POLARITY_POS     (16u) /* [16]  Polarity of the RTS output signal */
    #define GLCD_SPIM_SCB_UART_FLOW_CTRL_CTS_POLARITY_POS     (24u) /* [24]  Polarity of the CTS input signal  */
    #define GLCD_SPIM_SCB_UART_FLOW_CTRL_CTS_ENABLED_POS      (25u) /* [25]  Enable CTS signal                 */
    #define GLCD_SPIM_SCB_UART_FLOW_CTRL_TRIGGER_LEVEL_MASK   ((uint32) GLCD_SPIM_SCB_FF_DATA_NR_LOG2_MASK)
    #define GLCD_SPIM_SCB_UART_FLOW_CTRL_RTS_POLARITY         ((uint32) 0x01u << \
                                                                       GLCD_SPIM_SCB_UART_FLOW_CTRL_RTS_POLARITY_POS)
    #define GLCD_SPIM_SCB_UART_FLOW_CTRL_CTS_POLARITY         ((uint32) 0x01u << \
                                                                       GLCD_SPIM_SCB_UART_FLOW_CTRL_CTS_POLARITY_POS)
    #define GLCD_SPIM_SCB_UART_FLOW_CTRL_CTS_ENABLE           ((uint32) 0x01u << \
                                                                       GLCD_SPIM_SCB_UART_FLOW_CTRL_CTS_ENABLED_POS)
#endif /* !(GLCD_SPIM_SCB_CY_SCBIP_V0 || GLCD_SPIM_SCB_CY_SCBIP_V1) */

/* GLCD_SPIM_SCB_I2C_CTRL */
#define GLCD_SPIM_SCB_I2C_CTRL_HIGH_PHASE_OVS_POS           (0u)   /* [3:0] Oversampling factor high: master only */
#define GLCD_SPIM_SCB_I2C_CTRL_LOW_PHASE_OVS_POS            (4u)   /* [7:4] Oversampling factor low:  master only */
#define GLCD_SPIM_SCB_I2C_CTRL_M_READY_DATA_ACK_POS         (8u)   /* [8]   Master ACKs data while RX FIFO != FULL*/
...
#define GLCD_SPIM_SCB_I2C_CTRL_LOOPBACK_POS                 (16u)  /* [16]  Loop-back                             */
...
#define GLCD_SPIM_SCB_I2C_CTRL_LOW_PHASE_OVS_MASK   ((uint32) 0x0Fu << \
                                                                GLCD_SPIM_SCB_I2C_CTRL_LOW_PHASE_OVS_POS)
#define GLCD_SPIM_SCB_I2C_CTRL_M_READY_DATA_ACK      ((uint32) 0x01u << \
                                                                GLCD_SPIM_SCB_I2C_CTRL_M_READY_DATA_ACK_POS)
#define GLCD_SPIM_SCB_I2C_CTRL_M_NOT_READY_DATA_NACK ((uint32) 0x01u << \
                                                                GLCD_SPIM_SCB_I2C_CTRL_M_NOT_READY_DATA_NACK_POS)
#define GLCD_SPIM_SCB_I2C_CTRL_S_GENERAL_IGNORE      ((uint32) 0x01u << \
                                                                GLCD_SPIM_SCB_I2C_CTRL_S_GENERAL_IGNORE_POS)
#define GLCD_SPIM_SCB_I2C_CTRL_S_READY_ADDR_ACK      ((uint32) 0x01u << \
                                                                GLCD_SPIM_SCB_I2C_CTRL_S_READY_ADDR_ACK_POS)
#define GLCD_SPIM_SCB_I2C_CTRL_S_READY_DATA_ACK      ((uint32) 0x01u << \
                                                                GLCD_SPIM_SCB_I2C_CTRL_S_READY_DATA_ACK_POS)
#define GLCD_SPIM_SCB_I2C_CTRL_S_NOT_READY_ADDR_NACK ((uint32) 0x01u << \
                                                                GLCD_SPIM_SCB_I2C_CTRL_S_NOT_READY_ADDR_NACK_POS)
#define GLCD_SPIM_SCB_I2C_CTRL_S_NOT_READY_DATA_NACK ((uint32) 0x01u << \
                                                                GLCD_SPIM_SCB_I2C_CTRL_S_NOT_READY_DATA_NACK_POS)
#define GLCD_SPIM_SCB_I2C_CTRL_LOOPBACK              ((uint32) 0x01u << \
                                                                GLCD_SPIM_SCB_I2C_CTRL_LOOPBACK_POS)
#define GLCD_SPIM_SCB_I2C_CTRL_SLAVE_MODE            ((uint32) 0x01u << \
                                                                GLCD_SPIM_SCB_I2C_CTRL_SLAVE_MODE_POS)
#define GLCD_SPIM_SCB_I2C_CTRL_MASTER_MODE           ((uint32) 0x01u << \
                                                                GLCD_SPIM_SCB_I2C_CTRL_MASTER_MODE_POS)
#define GLCD_SPIM_SCB_I2C_CTRL_SLAVE_MASTER_MODE_MASK    ((uint32) 0x03u << \
                                                                GLCD_SPIM_SCB_I2C_CTRL_SLAVE_MODE_POS)
...
#define GLCD_SPIM_SCB_I2C_STATUS_S_READ          ((uint32) 0x01u << GLCD_SPIM_SCB_I2C_STATUS_S_READ_POS)
#define GLCD_SPIM_SCB_I2C_STATUS_M_READ          ((uint32) 0x01u << GLCD_SPIM_SCB_I2C_STATUS_M_READ_POS)
#define GLCD_SPIM_SCB_I2C_STATUS_EZBUF_ADDR_MASK ((uint32) 0xFFu << GLCD_SPIM_SCB_I2C_STATUS_EZBUF_ADDR_POS)
...
#define GLCD_SPIM_SCB_I2C_MASTER_CMD_M_START_ON_IDLE ((uint32) 0x01u << \
                                                                   GLCD_SPIM_SCB_I2C_MASTER_CMD_M_START_ON_IDLE_POS)
#define GLCD_SPIM_SCB_I2C_MASTER_CMD_M_ACK           ((uint32) 0x01u << \
                                                                   GLCD_SPIM_SCB_I2C_MASTER_CMD_M_ACK_POS)
#define GLCD_SPIM_SCB_I2C_MASTER_CMD_M_NACK          ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_I2C_MASTER_CMD_M_NACK_POS)
#define GLCD_SPIM_SCB_I2C_MASTER_CMD_M_STOP          ((uint32) 0x01u << \
...
#define GLCD_SPIM_SCB_I2C_SLAVE_CMD_S_NACK       ((uint32) 0x01u << GLCD_SPIM_SCB_I2C_SLAVE_CMD_S_NACK_POS)
...
#define GLCD_SPIM_SCB_I2C_CFG_SDA_FILT_OUT_HS_POS        (26u) /* [26]    '0': 50 ns filter, '1': 10 ns filter     */
#define GLCD_SPIM_SCB_I2C_CFG_SDA_FILT_OUT_ENABLED_POS   (27u) /* [27]    I2C SDA output delay filter enabled      */
#define GLCD_SPIM_SCB_I2C_CFG_SDA_FILT_HYS_MASK          ((uint32) 0x03u)
#define GLCD_SPIM_SCB_I2C_CFG_SDA_FILT_TRIM_MASK         ((uint32) 0x03u << \
                                                                GLCD_SPIM_SCB_I2C_CFG_SDA_FILT_TRIM_POS)
#define GLCD_SPIM_SCB_I2C_CFG_SCL_FILT_HYS_MASK          ((uint32) 0x03u << \
                                                                GLCD_SPIM_SCB_I2C_CFG_SCL_FILT_HYS_POS)
#define GLCD_SPIM_SCB_I2C_CFG_SCL_FILT_TRIM_MASK         ((uint32) 0x03u << \
                                                                GLCD_SPIM_SCB_I2C_CFG_SCL_FILT_TRIM_POS)
#define GLCD_SPIM_SCB_I2C_CFG_SDA_FILT_OUT_HYS_MASK      ((uint32) 0x03u << \
                                                                GLCD_SPIM_SCB_I2C_CFG_SDA_FILT_OUT_HYS_POS)
#define GLCD_SPIM_SCB_I2C_CFG_SDA_FILT_OUT_TRIM_MASK     ((uint32) 0x03u << \
                                                                GLCD_SPIM_SCB_I2C_CFG_SDA_FILT_OUT_TRIM_POS)
#define GLCD_SPIM_SCB_I2C_CFG_SDA_FILT_HS                ((uint32) 0x01u << \
                                                                GLCD_SPIM_SCB_I2C_CFG_SDA_FILT_HS_POS)
#define GLCD_SPIM_SCB_I2C_CFG_SDA_FILT_ENABLED           ((uint32) 0x01u << \
                                                                GLCD_SPIM_SCB_I2C_CFG_SDA_FILT_ENABLED_POS)
#define GLCD_SPIM_SCB_I2C_CFG_SCL_FILT_HS                ((uint32) 0x01u << \
                                                                GLCD_SPIM_SCB_I2C_CFG_SCL_FILT_HS_POS)
#define GLCD_SPIM_SCB_I2C_CFG_SCL_FILT_ENABLED           ((uint32) 0x01u << \
                                                                GLCD_SPIM_SCB_I2C_CFG_SCL_FILT_ENABLED_POS)
#define GLCD_SPIM_SCB_I2C_CFG_SDA_FILT_OUT_HS            ((uint32) 0x01u << \
                                                                GLCD_SPIM_SCB_I2C_CFG_SDA_FILT_OUT_HS_POS)
#define GLCD_SPIM_SCB_I2C_CFG_SDA_FILT_OUT_ENABLED       ((uint32) 0x01u << \
                                                                GLCD_SPIM_SCB_I2C_CFG_SDA_FILT_OUT_ENABLED_POS)
#else
#define GLCD_SPIM_SCB_I2C_CFG_SDA_IN_FILT_TRIM_POS   (0u)  /* [1:0] Trim bits for "i2c_sda_in" 50 ns filter */
#define GLCD_SPIM_SCB_I2C_CFG_SDA_IN_FILT_SEL_POS    (4u)  /* [4]   "i2c_sda_in" filter delay: 0 ns and 50 ns */
#define GLCD_SPIM_SCB_I2C_CFG_SCL_IN_FILT_TRIM_POS   (8u)  /* [9:8] Trim bits for "i2c_scl_in" 50 ns filter */
#define GLCD_SPIM_SCB_I2C_CFG_SCL_IN_FILT_SEL_POS    (12u) /* [12]  "i2c_scl_in" filter delay: 0 ns and 50 ns */
#define GLCD_SPIM_SCB_I2C_CFG_SDA_OUT_FILT0_TRIM_POS (16u) /* [17:16] Trim bits for "i2c_sda_out" 50 ns filter 0 */
#define GLCD_SPIM_SCB_I2C_CFG_SDA_OUT_FILT1_TRIM_POS (18u) /* [19:18] Trim bits for "i2c_sda_out" 50 ns filter 1 */
#define GLCD_SPIM_SCB_I2C_CFG_SDA_OUT_FILT2_TRIM_POS (20u) /* [21:20] Trim bits for "i2c_sda_out" 50 ns filter 2 */
#define GLCD_SPIM_SCB_I2C_CFG_SDA_OUT_FILT_SEL_POS   (28u) /* [29:28] Cumulative "i2c_sda_out" filter delay: */

#define GLCD_SPIM_SCB_I2C_CFG_SDA_IN_FILT_TRIM_MASK  ((uint32) 0x03u)
#define GLCD_SPIM_SCB_I2C_CFG_SDA_IN_FILT_SEL        ((uint32) 0x01u << GLCD_SPIM_SCB_I2C_CFG_SDA_IN_FILT_SEL_POS)
#define GLCD_SPIM_SCB_I2C_CFG_SCL_IN_FILT_TRIM_MASK  ((uint32) 0x03u << \
                                                            GLCD_SPIM_SCB_I2C_CFG_SCL_IN_FILT_TRIM_POS)
#define GLCD_SPIM_SCB_I2C_CFG_SCL_IN_FILT_SEL        ((uint32) 0x01u << GLCD_SPIM_SCB_I2C_CFG_SCL_IN_FILT_SEL_POS)
#define GLCD_SPIM_SCB_I2C_CFG_SDA_OUT_FILT0_TRIM_MASK ((uint32) 0x03u << \
                                                            GLCD_SPIM_SCB_I2C_CFG_SDA_OUT_FILT0_TRIM_POS)
#define GLCD_SPIM_SCB_I2C_CFG_SDA_OUT_FILT1_TRIM_MASK ((uint32) 0x03u << \
                                                            GLCD_SPIM_SCB_I2C_CFG_SDA_OUT_FILT1_TRIM_POS)
#define GLCD_SPIM_SCB_I2C_CFG_SDA_OUT_FILT2_TRIM_MASK ((uint32) 0x03u << \
                                                            GLCD_SPIM_SCB_I2C_CFG_SDA_OUT_FILT2_TRIM_POS)
#define GLCD_SPIM_SCB_I2C_CFG_SDA_OUT_FILT_SEL_MASK   ((uint32) 0x03u << \
                                                            GLCD_SPIM_SCB_I2C_CFG_SDA_OUT_FILT_SEL_POS)
#endif /* (GLCD_SPIM_SCB_CY_SCBIP_V0) */


/* GLCD_SPIM_SCB_TX_CTRL_REG */
#define GLCD_SPIM_SCB_TX_CTRL_DATA_WIDTH_POS     (0u)  /* [3:0] Data frame width: (Data width - 1) */
...
#define GLCD_SPIM_SCB_TX_CTRL_MSB_FIRST          ((uint32) 0x01u << GLCD_SPIM_SCB_TX_CTRL_MSB_FIRST_POS)
#define GLCD_SPIM_SCB_TX_CTRL_LSB_FIRST          ((uint32) 0x00u)
#define GLCD_SPIM_SCB_TX_CTRL_ENABLED            ((uint32) 0x01u << GLCD_SPIM_SCB_TX_CTRL_ENABLED_POS)

/* GLCD_SPIM_SCB_TX_CTRL_FIFO_REG */
#define GLCD_SPIM_SCB_TX_FIFO_CTRL_TRIGGER_LEVEL_POS     (0u)  /* [2:0] Trigger level                              */
#define GLCD_SPIM_SCB_TX_FIFO_CTRL_CLEAR_POS             (16u) /* [16]  Clear TX FIFO: cleared after set           */
#define GLCD_SPIM_SCB_TX_FIFO_CTRL_FREEZE_POS            (17u) /* [17]  Freeze TX FIFO: HW do not inc read pointer */
#define GLCD_SPIM_SCB_TX_FIFO_CTRL_TRIGGER_LEVEL_MASK    ((uint32) GLCD_SPIM_SCB_FF_DATA_NR_LOG2_MASK)
#define GLCD_SPIM_SCB_TX_FIFO_CTRL_CLEAR                 ((uint32) 0x01u << GLCD_SPIM_SCB_TX_FIFO_CTRL_CLEAR_POS)
#define GLCD_SPIM_SCB_TX_FIFO_CTRL_FREEZE                ((uint32) 0x01u << GLCD_SPIM_SCB_TX_FIFO_CTRL_FREEZE_POS)
...
#define GLCD_SPIM_SCB_TX_FIFO_STATUS_USED_MASK   ((uint32) GLCD_SPIM_SCB_FF_DATA_NR_LOG2_PLUS1_MASK)
#define GLCD_SPIM_SCB_TX_FIFO_SR_VALID           ((uint32) 0x01u << GLCD_SPIM_SCB_TX_FIFO_SR_VALID_POS)
#define GLCD_SPIM_SCB_TX_FIFO_STATUS_RD_PTR_MASK ((uint32) GLCD_SPIM_SCB_FF_DATA_NR_LOG2_MASK << \
                                                                    GLCD_SPIM_SCB_TX_FIFO_STATUS_RD_PTR_POS)
#define GLCD_SPIM_SCB_TX_FIFO_STATUS_WR_PTR_MASK ((uint32) GLCD_SPIM_SCB_FF_DATA_NR_LOG2_MASK << \
...
#define GLCD_SPIM_SCB_RX_CTRL_DATA_WIDTH_POS     (0u)  /* [3:0] Data frame width: (Data width - 1) */
...
#define GLCD_SPIM_SCB_RX_CTRL_MSB_FIRST          ((uint32) 0x01u << GLCD_SPIM_SCB_RX_CTRL_MSB_FIRST_POS)
#define GLCD_SPIM_SCB_RX_CTRL_LSB_FIRST          ((uint32) 0x00u)
#define GLCD_SPIM_SCB_RX_CTRL_MEDIAN             ((uint32) 0x01u << GLCD_SPIM_SCB_RX_CTRL_MEDIAN_POS)
#define GLCD_SPIM_SCB_RX_CTRL_ENABLED            ((uint32) 0x01u << GLCD_SPIM_SCB_RX_CTRL_ENABLED_POS)


/* GLCD_SPIM_SCB_RX_FIFO_CTRL_REG */
#define GLCD_SPIM_SCB_RX_FIFO_CTRL_TRIGGER_LEVEL_POS     (0u)   /* [2:0] Trigger level                            */
#define GLCD_SPIM_SCB_RX_FIFO_CTRL_CLEAR_POS             (16u)  /* [16]  Clear RX FIFO: clear after set           */
#define GLCD_SPIM_SCB_RX_FIFO_CTRL_FREEZE_POS            (17u)  /* [17]  Freeze RX FIFO: HW writes has not effect */
#define GLCD_SPIM_SCB_RX_FIFO_CTRL_TRIGGER_LEVEL_MASK    ((uint32) GLCD_SPIM_SCB_FF_DATA_NR_LOG2_MASK)
#define GLCD_SPIM_SCB_RX_FIFO_CTRL_CLEAR                 ((uint32) 0x01u << GLCD_SPIM_SCB_RX_FIFO_CTRL_CLEAR_POS)
#define GLCD_SPIM_SCB_RX_FIFO_CTRL_FREEZE                ((uint32) 0x01u << GLCD_SPIM_SCB_RX_FIFO_CTRL_FREEZE_POS)
...
#define GLCD_SPIM_SCB_RX_FIFO_STATUS_USED_MASK   ((uint32) GLCD_SPIM_SCB_FF_DATA_NR_LOG2_PLUS1_MASK)
#define GLCD_SPIM_SCB_RX_FIFO_SR_VALID           ((uint32) 0x01u << GLCD_SPIM_SCB_RX_FIFO_SR_VALID_POS)
#define GLCD_SPIM_SCB_RX_FIFO_STATUS_RD_PTR_MASK ((uint32) GLCD_SPIM_SCB_FF_DATA_NR_LOG2_MASK << \
                                                                    GLCD_SPIM_SCB_RX_FIFO_STATUS_RD_PTR_POS)
#define GLCD_SPIM_SCB_RX_FIFO_STATUS_WR_PTR_MASK ((uint32) GLCD_SPIM_SCB_FF_DATA_NR_LOG2_MASK << \
...
#define GLCD_SPIM_SCB_RX_MATCH_MASK_MASK    ((uint32) 0xFFu << GLCD_SPIM_SCB_RX_MATCH_MASK_POS)
...
#define GLCD_SPIM_SCB_INTR_CAUSE_SLAVE       ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_CAUSE_SLAVE_POS)
#define GLCD_SPIM_SCB_INTR_CAUSE_TX          ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_CAUSE_TX_POS)
#define GLCD_SPIM_SCB_INTR_CAUSE_RX          ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_CAUSE_RX_POS)
#define GLCD_SPIM_SCB_INTR_CAUSE_I2C_EC      ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_CAUSE_I2C_EC_POS)
#define GLCD_SPIM_SCB_INTR_CAUSE_SPI_EC      ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_CAUSE_SPI_EC_POS)
...
#define GLCD_SPIM_SCB_INTR_SPI_EC_EZBUF_STOP           ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_INTR_SPI_EC_EZBUF_STOP_POS)
#define GLCD_SPIM_SCB_INTR_SPI_EC_EZBUF_WRITE_STOP     ((uint32) 0x01u << \
...
#define GLCD_SPIM_SCB_INTR_I2C_EC_EZBUF_STOP           ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_INTR_I2C_EC_EZBUF_STOP_POS)
#define GLCD_SPIM_SCB_INTR_I2C_EC_EZBUF_WRITE_STOP     ((uint32) 0x01u << \
...
#define GLCD_SPIM_SCB_INTR_MASTER_SPI_DONE_POS       (9u)  /* [9] Master complete transfer: Only for SPI           */
#define GLCD_SPIM_SCB_INTR_MASTER_I2C_ARB_LOST       ((uint32) 0x01u)
#define GLCD_SPIM_SCB_INTR_MASTER_I2C_NACK           ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_MASTER_I2C_NACK_POS)
#define GLCD_SPIM_SCB_INTR_MASTER_I2C_ACK            ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_MASTER_I2C_ACK_POS)
#define GLCD_SPIM_SCB_INTR_MASTER_I2C_STOP           ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_MASTER_I2C_STOP_POS)
#define GLCD_SPIM_SCB_INTR_MASTER_I2C_BUS_ERROR      ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_INTR_MASTER_I2C_BUS_ERROR_POS)
#define GLCD_SPIM_SCB_INTR_MASTER_SPI_DONE           ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_MASTER_SPI_DONE_POS)
...
#define GLCD_SPIM_SCB_INTR_SLAVE_I2C_STOP_POS             (4u)  /* [4]  Slave detects end of transaction intended */
...
#define GLCD_SPIM_SCB_INTR_SLAVE_SPI_EZBUF_STOP_POS       (10u) /* [10] Slave end of transaction: Only for SPI   */
...
#define GLCD_SPIM_SCB_INTR_SLAVE_I2C_NACK                 ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_INTR_SLAVE_I2C_NACK_POS)
#define GLCD_SPIM_SCB_INTR_SLAVE_I2C_ACK                  ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_INTR_SLAVE_I2C_ACK_POS)
#define GLCD_SPIM_SCB_INTR_SLAVE_I2C_WRITE_STOP           ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_INTR_SLAVE_I2C_WRITE_STOP_POS)
#define GLCD_SPIM_SCB_INTR_SLAVE_I2C_STOP                 ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_INTR_SLAVE_I2C_STOP_POS)
#define GLCD_SPIM_SCB_INTR_SLAVE_I2C_START                ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_INTR_SLAVE_I2C_START_POS)
#define GLCD_SPIM_SCB_INTR_SLAVE_I2C_ADDR_MATCH           ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_INTR_SLAVE_I2C_ADDR_MATCH_POS)
#define GLCD_SPIM_SCB_INTR_SLAVE_I2C_GENERAL              ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_INTR_SLAVE_I2C_GENERAL_POS)
#define GLCD_SPIM_SCB_INTR_SLAVE_I2C_BUS_ERROR            ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_INTR_SLAVE_I2C_BUS_ERROR_POS)
#define GLCD_SPIM_SCB_INTR_SLAVE_SPI_EZBUF_WRITE_STOP     ((uint32) 0x01u << \
                                                                   GLCD_SPIM_SCB_INTR_SLAVE_SPI_EZBUF_WRITE_STOP_POS)
#define GLCD_SPIM_SCB_INTR_SLAVE_SPI_EZBUF_STOP           ((uint32) 0x01u << \
                                                                    GLCD_SPIM_SCB_INTR_SLAVE_SPI_EZBUF_STOP_POS)
#define GLCD_SPIM_SCB_INTR_SLAVE_SPI_BUS_ERROR           ((uint32) 0x01u << \
...
#define GLCD_SPIM_SCB_INTR_TX_FIFO_LEVEL         (GLCD_SPIM_SCB_INTR_TX_TRIGGER)
#define GLCD_SPIM_SCB_INTR_TX_NOT_FULL           ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_TX_NOT_FULL_POS)
#define GLCD_SPIM_SCB_INTR_TX_EMPTY              ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_TX_EMPTY_POS)
#define GLCD_SPIM_SCB_INTR_TX_OVERFLOW           ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_TX_OVERFLOW_POS)
#define GLCD_SPIM_SCB_INTR_TX_UNDERFLOW          ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_TX_UNDERFLOW_POS)
#define GLCD_SPIM_SCB_INTR_TX_BLOCKED            ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_TX_BLOCKED_POS)
#define GLCD_SPIM_SCB_INTR_TX_UART_NACK          ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_TX_UART_NACK_POS)
#define GLCD_SPIM_SCB_INTR_TX_UART_DONE          ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_TX_UART_DONE_POS)
#define GLCD_SPIM_SCB_INTR_TX_UART_ARB_LOST      ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_TX_UART_ARB_LOST_POS)
...
#define GLCD_SPIM_SCB_INTR_RX_BAUD_DETECT_POS    (10u)  /* [10] LIN baud rate detection is completed   */
...
#define GLCD_SPIM_SCB_INTR_RX_FIFO_LEVEL         (GLCD_SPIM_SCB_INTR_RX_TRIGGER)
#define GLCD_SPIM_SCB_INTR_RX_NOT_EMPTY          ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_RX_NOT_EMPTY_POS)
#define GLCD_SPIM_SCB_INTR_RX_FULL               ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_RX_FULL_POS)
#define GLCD_SPIM_SCB_INTR_RX_OVERFLOW           ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_RX_OVERFLOW_POS)
#define GLCD_SPIM_SCB_INTR_RX_UNDERFLOW          ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_RX_UNDERFLOW_POS)
#define GLCD_SPIM_SCB_INTR_RX_BLOCKED            ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_RX_BLOCKED_POS)
#define GLCD_SPIM_SCB_INTR_RX_FRAME_ERROR        ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_RX_FRAME_ERROR_POS)
#define GLCD_SPIM_SCB_INTR_RX_PARITY_ERROR       ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_RX_PARITY_ERROR_POS)
#define GLCD_SPIM_SCB_INTR_RX_BAUD_DETECT        ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_RX_BAUD_DETECT_POS)
#define GLCD_SPIM_SCB_INTR_RX_BREAK_DETECT       ((uint32) 0x01u << GLCD_SPIM_SCB_INTR_RX_BREAK_DETECT_POS)
...
/* Write interrupt source: set sourceMask bits in GLCD_SPIM_SCB_INTR_X_MASK_REG */
...
/* Enable interrupt source: set sourceMask bits in GLCD_SPIM_SCB_INTR_X_MASK_REG */
...
/* Disable interrupt source: clear sourceMask bits in GLCD_SPIM_SCB_INTR_X_MASK_REG */
...
/* Set interrupt sources: write sourceMask bits in GLCD_SPIM_SCB_INTR_X_SET_REG */
...
/* Clear interrupt sources: write sourceMask bits in GLCD_SPIM_SCB_INTR_X_REG */
...
#define GLCD_SPIM_SCB_CHECK_INTR_I2C_EC(sourceMask)  (0u != (GLCD_SPIM_SCB_INTR_I2C_EC_REG & (sourceMask)))
#if (!GLCD_SPIM_SCB_CY_SCBIP_V1)
    #define GLCD_SPIM_SCB_CHECK_INTR_SPI_EC(sourceMask)  (0u != (GLCD_SPIM_SCB_INTR_SPI_EC_REG & (sourceMask)))
#endif /* (!GLCD_SPIM_SCB_CY_SCBIP_V1) */
...
/* Return true if sourceMask is set in GLCD_SPIM_SCB_CTRL_REG: generally is used to check enable bit */
...
#define GLCD_SPIM_SCB_I2C_SLAVE_GENERATE_ACK \
    ...
    void GLCD_SPIM_SCB_I2CSlaveNackGeneration(void);
    #define GLCD_SPIM_SCB_I2C_SLAVE_GENERATE_NACK GLCD_SPIM_SCB_I2CSlaveNackGeneration()
...
#define GLCD_SPIM_SCB_I2C_SLAVE_CLEAR_NACK \
                            do{               \
                                GLCD_SPIM_SCB_I2C_SLAVE_CMD_REG = 0u; \
                            }while(0)
...
#define GLCD_SPIM_SCB_GET_I2C_7BIT_ADDRESS(addr) ((uint32) (addr) >> GLCD_SPIM_SCB_I2C_SLAVE_ADDR_POS)
...
#define GLCD_SPIM_SCB_DIGITAL_FILTER_DISABLE    (0u)
#define GLCD_SPIM_SCB_DIGITAL_FILTER_ENABLE     (1u)
#define GLCD_SPIM_SCB_I2C_DATA_RATE_FS_MODE_MAX (400u)
#if (GLCD_SPIM_SCB_CY_SCBIP_V0)
    /* GLCD_SPIM_SCB_I2C_CFG_SDA_FILT_OUT_ENABLED is disabled by default */
    #define GLCD_SPIM_SCB_I2C_CFG_FILT_MASK  (GLCD_SPIM_SCB_I2C_CFG_SDA_FILT_ENABLED | \
                                                 GLCD_SPIM_SCB_I2C_CFG_SCL_FILT_ENABLED)
#else
    /* GLCD_SPIM_SCB_I2C_CFG_SDA_OUT_FILT_SEL_MASK is disabled by default */
    #define GLCD_SPIM_SCB_I2C_CFG_FILT_MASK  (GLCD_SPIM_SCB_I2C_CFG_SDA_IN_FILT_SEL | \
                                                 GLCD_SPIM_SCB_I2C_CFG_SCL_IN_FILT_SEL)
#endif /* (GLCD_SPIM_SCB_CY_SCBIP_V0) */

#define GLCD_SPIM_SCB_I2C_CFG_ANALOG_FITER_DISABLE \
        do{                                           \
            GLCD_SPIM_SCB_I2C_CFG_REG &= (uint32) ~GLCD_SPIM_SCB_I2C_CFG_FILT_MASK; \
        }while(0)

#define GLCD_SPIM_SCB_I2C_CFG_ANALOG_FITER_ENABLE \
        do{                                          \
            GLCD_SPIM_SCB_I2C_CFG_REG |= (uint32)  GLCD_SPIM_SCB_I2C_CFG_FILT_MASK; \
        }while(0)
...
/* Return true if bit is set in GLCD_SPIM_SCB_I2C_STATUS_REG */
#define GLCD_SPIM_SCB_CHECK_I2C_STATUS(sourceMask)   (0u != (GLCD_SPIM_SCB_I2C_STATUS_REG & (sourceMask)))

/* Return true if bit is set in GLCD_SPIM_SCB_SPI_STATUS_REG */
#define GLCD_SPIM_SCB_CHECK_SPI_STATUS(sourceMask)   (0u != (GLCD_SPIM_SCB_SPI_STATUS_REG & (sourceMask)))

/* Return FIFO size depends on GLCD_SPIM_SCB_CTRL_BYTE_MODE bit */
#define GLCD_SPIM_SCB_GET_FIFO_SIZE(condition) ((0u != (condition)) ? \
                                                    (2u * GLCD_SPIM_SCB_FIFO_SIZE) : (GLCD_SPIM_SCB_FIFO_SIZE))
...
#if (GLCD_SPIM_SCB_CY_SCBIP_V0 || GLCD_SPIM_SCB_CY_SCBIP_V1)
    #define GLCD_SPIM_SCB_GET_CTRL_BYTE_MODE(mode)   (0u)
#else
    #define GLCD_SPIM_SCB_GET_CTRL_BYTE_MODE(mode)   ((0u != (mode)) ? \
                                                            (GLCD_SPIM_SCB_CTRL_BYTE_MODE) : (0u))
#endif /* (GLCD_SPIM_SCB_CY_SCBIP_V0 || GLCD_SPIM_SCB_CY_SCBIP_V1) */
...
#define GLCD_SPIM_SCB_GET_I2C_CTRL_LOW_PHASE_OVS(oversampleLow)  ((((uint32) (oversampleLow) - 1u) << \
                                                                    GLCD_SPIM_SCB_I2C_CTRL_LOW_PHASE_OVS_POS) &  \
...
#define GLCD_SPIM_SCB_GET_I2C_CTRL_S_GENERAL_IGNORE(genCall) ((0u != (genCall)) ? \
                                                                    (GLCD_SPIM_SCB_I2C_CTRL_S_GENERAL_IGNORE) : (0u))

#define GLCD_SPIM_SCB_GET_I2C_CTRL_SL_MSTR_MODE(mode)    ((uint32)(mode) << GLCD_SPIM_SCB_I2C_CTRL_SLAVE_MODE_POS)
...
#define GLCD_SPIM_SCB_GET_SPI_CTRL_SCLK_MODE(mode)       (((uint32) (mode) << \
...
#if (GLCD_SPIM_SCB_CY_SCBIP_V0 || GLCD_SPIM_SCB_CY_SCBIP_V1)
    #define GLCD_SPIM_SCB_GET_SPI_CTRL_SCLK_CONTINUOUS(sclkType) (0u)
    #define GLCD_SPIM_SCB_GET_SPI_CTRL_SSEL_POLARITY(polarity)   (0u)
#else
    #define GLCD_SPIM_SCB_GET_SPI_CTRL_SCLK_CONTINUOUS(sclkType) ((0u != (sclkType)) ? \
                                                                    (GLCD_SPIM_SCB_SPI_CTRL_SCLK_CONTINUOUS) : (0u))

    #define GLCD_SPIM_SCB_GET_SPI_CTRL_SSEL_POLARITY(polarity)   (((uint32) (polarity) << \
                                                                     GLCD_SPIM_SCB_SPI_CTRL_SSEL0_POLARITY_POS) & \
                                                                     GLCD_SPIM_SCB_SPI_CTRL_SSEL_POLARITY_MASK)
#endif /* ((GLCD_SPIM_SCB_CY_SCBIP_V0 || GLCD_SPIM_SCB_CY_SCBIP_V1) */

#define GLCD_SPIM_SCB_GET_SPI_CTRL_SUB_MODE(mode)        (((uint32) (mode) << GLCD_SPIM_SCB_SPI_CTRL_MODE_POS) & \
                                                                                 GLCD_SPIM_SCB_SPI_CTRL_MODE_MASK)

#define GLCD_SPIM_SCB_GET_SPI_CTRL_SLAVE_SELECT(select)  (((uint32) (select) << \
                                                                      GLCD_SPIM_SCB_SPI_CTRL_SLAVE_SELECT_POS) & \
                                                                      GLCD_SPIM_SCB_SPI_CTRL_SLAVE_SELECT_MASK)
...
/* GLCD_SPIM_SCB_UART_CTRL */
#define GLCD_SPIM_SCB_GET_UART_CTRL_MODE(mode)           (((uint32) (mode) << \
...
/* GLCD_SPIM_SCB_UART_FLOW_CTRL */
#if !(GLCD_SPIM_SCB_CY_SCBIP_V0 || GLCD_SPIM_SCB_CY_SCBIP_V1)
    #define GLCD_SPIM_SCB_GET_UART_FLOW_CTRL_TRIGGER_LEVEL(level)   ( (uint32) (level) & \
                                                                 GLCD_SPIM_SCB_UART_FLOW_CTRL_TRIGGER_LEVEL_MASK)

    #define GLCD_SPIM_SCB_GET_UART_FLOW_CTRL_RTS_POLARITY(polarity) ((0u != (polarity)) ? \
                                                                (GLCD_SPIM_SCB_UART_FLOW_CTRL_RTS_POLARITY) : (0u))

    #define GLCD_SPIM_SCB_GET_UART_FLOW_CTRL_CTS_POLARITY(polarity) ((0u != (polarity)) ? \
                                                                (GLCD_SPIM_SCB_UART_FLOW_CTRL_CTS_POLARITY) : (0u))

    #define GLCD_SPIM_SCB_GET_UART_FLOW_CTRL_CTS_ENABLE(ctsEn)      ((0u != (ctsEn)) ? \
                                                                (GLCD_SPIM_SCB_UART_FLOW_CTRL_CTS_ENABLE) : (0u))
#endif /* !(GLCD_SPIM_SCB_CY_SCBIP_V0 || GLCD_SPIM_SCB_CY_SCBIP_V1) */
...
#define GLCD_SPIM_SCB_GET_RX_MATCH_MASK(mask)    (((uint32) (mask) << \
...
/* GLCD_SPIM_SCB_INTR_SLAVE_I2C_GENERAL */
#define GLCD_SPIM_SCB_GET_INTR_SLAVE_I2C_GENERAL(genCall)  ((0u != (genCall)) ? \
                                                                (GLCD_SPIM_SCB_INTR_SLAVE_I2C_GENERAL) : (0u))

/* Return true if master mode is enabled GLCD_SPIM_SCB_SPI_CTRL_REG */
#define GLCD_SPIM_SCB_CHECK_SPI_MASTER   (0u != (GLCD_SPIM_SCB_SPI_CTRL_REG & GLCD_SPIM_SCB_SPI_CTRL_MASTER))

/* Return inactive state of SPI SCLK line depends on CPOL */
#define GLCD_SPIM_SCB_GET_SPI_SCLK_INACTIVE \
            ((0u == (GLCD_SPIM_SCB_SPI_CTRL_REG & GLCD_SPIM_SCB_SPI_CTRL_CPOL)) ? (0u) : (1u))

/* Get output pin inactive state */
#if (GLCD_SPIM_SCB_CY_SCBIP_V0 || GLCD_SPIM_SCB_CY_SCBIP_V1)
#define GLCD_SPIM_SCB_GET_SPI_SS0_INACTIVE       (1u)
#define GLCD_SPIM_SCB_GET_SPI_SS1_INACTIVE       (1u)
#define GLCD_SPIM_SCB_GET_SPI_SS2_INACTIVE       (1u)
#define GLCD_SPIM_SCB_GET_SPI_SS3_INACTIVE       (1u)
#define GLCD_SPIM_SCB_GET_UART_RTS_INACTIVE      (1u)

#else
#define GLCD_SPIM_SCB_GET_SPI_SS0_INACTIVE  \
        ((0u != (GLCD_SPIM_SCB_SPI_CTRL_REG & GLCD_SPIM_SCB_SPI_CTRL_SSEL0_POLARITY)) ? (0u) : (1u))

#define GLCD_SPIM_SCB_GET_SPI_SS1_INACTIVE  \
        ((0u != (GLCD_SPIM_SCB_SPI_CTRL_REG & GLCD_SPIM_SCB_SPI_CTRL_SSEL1_POLARITY)) ? (0u) : (1u))

#define GLCD_SPIM_SCB_GET_SPI_SS2_INACTIVE  \
        ((0u != (GLCD_SPIM_SCB_SPI_CTRL_REG & GLCD_SPIM_SCB_SPI_CTRL_SSEL2_POLARITY)) ? (0u) : (1u))

#define GLCD_SPIM_SCB_GET_SPI_SS3_INACTIVE  \
        ((0u != (GLCD_SPIM_SCB_SPI_CTRL_REG & GLCD_SPIM_SCB_SPI_CTRL_SSEL3_POLARITY)) ? (0u) : (1u))

#define GLCD_SPIM_SCB_GET_UART_RTS_INACTIVE \
        ((0u == (GLCD_SPIM_SCB_UART_FLOW_CTRL_REG & GLCD_SPIM_SCB_UART_FLOW_CTRL_RTS_POLARITY)) ? (0u) : (1u))
...
#define GLCD_SPIM_SCB_CHECK_INTR_EC_I2C(sourceMask)  GLCD_SPIM_SCB_CHECK_INTR_I2C_EC(sourceMask)
#if (!GLCD_SPIM_SCB_CY_SCBIP_V1)
    #define GLCD_SPIM_SCB_CHECK_INTR_EC_SPI(sourceMask)  GLCD_SPIM_SCB_CHECK_INTR_SPI_EC(sourceMask)
#endif /* (!GLCD_SPIM_SCB_CY_SCBIP_V1) */

#define GLCD_SPIM_SCB_CY_SCBIP_V1_I2C_ONLY   (GLCD_SPIM_SCB_CY_SCBIP_V1)
#define GLCD_SPIM_SCB_EZBUFFER_SIZE          (GLCD_SPIM_SCB_EZ_DATA_NR)

#define GLCD_SPIM_SCB_EZBUF_DATA00_REG   GLCD_SPIM_SCB_EZBUF_DATA0_REG
#define GLCD_SPIM_SCB_EZBUF_DATA00_PTR   GLCD_SPIM_SCB_EZBUF_DATA0_PTR

...
#include "GLCD_SPIM_SCB_SPI_UART_PVT.h"
    ...
    ***************************************/
    ...
    const GLCD_SPIM_SCB_SPI_INIT_STRUCT GLCD_SPIM_SCB_configSpi =
    {
        ...
        0u,
        NULL,
        (uint32) GLCD_SPIM_SCB_SCB_IRQ_INTERNAL,
        ...
        (uint8) GLCD_SPIM_SCB_SPI_BYTE_MODE_ENABLE,
        (uint8) GLCD_SPIM_SCB_SPI_FREE_RUN_SCLK_ENABLE,
        (uint8) GLCD_SPIM_SCB_SPI_SS_POLARITY
    };
    ...
    ****************************************************************************//**
    *
    *  Configures the GLCD_SPIM_SCB for SPI operation.
    *
    *  This function is intended specifically to be used when the GLCD_SPIM_SCB 
    *  configuration is set to “Unconfigured GLCD_SPIM_SCB” in the customizer. 
    *  After initializing the GLCD_SPIM_SCB in SPI mode using this function, 
    *  the component can be enabled using the GLCD_SPIM_SCB_Start() or 
    * GLCD_SPIM_SCB_Enable() function.
    ...
    *******************************************************************************/
    void GLCD_SPIM_SCB_SpiInit(const GLCD_SPIM_SCB_SPI_INIT_STRUCT *config)
    {
        ...
        else
        {
            ...
            GLCD_SPIM_SCB_scbEnableIntr = (uint8) config->enableInterrupt;
            ...
            GLCD_SPIM_SCB_CTRL_REG     = GLCD_SPIM_SCB_GET_CTRL_OVS(config->oversample)           |
                                            GLCD_SPIM_SCB_GET_CTRL_BYTE_MODE(config->enableByteMode) |
            ...
            GLCD_SPIM_SCB_SPI_CTRL_REG = GLCD_SPIM_SCB_GET_SPI_CTRL_CONTINUOUS    (config->transferSeperation)  |
                                            ...
                                            GLCD_SPIM_SCB_GET_SPI_CTRL_SCLK_CONTINUOUS(config->enableFreeRunSclk)  |
                                            GLCD_SPIM_SCB_GET_SPI_CTRL_SSEL_POLARITY (config->polaritySs)          |
            ...
            CyIntDisable    (GLCD_SPIM_SCB_ISR_NUMBER);
            CyIntSetPriority(GLCD_SPIM_SCB_ISR_NUMBER, GLCD_SPIM_SCB_ISR_PRIORITY);
            (void) CyIntSetVector(GLCD_SPIM_SCB_ISR_NUMBER, &GLCD_SPIM_SCB_SPI_UART_ISR);
            ...
            GLCD_SPIM_SCB_IntrTxMask = LO16(GLCD_SPIM_SCB_INTR_TX_MASK_REG);

            /* Set active SS0 */
            GLCD_SPIM_SCB_SpiSetActiveSlaveSelect(GLCD_SPIM_SCB_SPI_SLAVE_SELECT0);
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_SpiPostEnable
****************************************************************************//**
*
...
void GLCD_SPIM_SCB_SpiPostEnable(void)
{
    ...
    if (GLCD_SPIM_SCB_CHECK_SPI_MASTER)
    {
        ...
        GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SCLK_HSIOM_REG, GLCD_SPIM_SCB_SCLK_HSIOM_MASK,
                                       GLCD_SPIM_SCB_SCLK_HSIOM_POS, GLCD_SPIM_SCB_SCLK_HSIOM_SEL_SPI);
        ...
        GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SS0_HSIOM_REG, GLCD_SPIM_SCB_SS0_HSIOM_MASK,
                                       GLCD_SPIM_SCB_SS0_HSIOM_POS, GLCD_SPIM_SCB_SS0_HSIOM_SEL_SPI);
        ...
        GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SS1_HSIOM_REG, GLCD_SPIM_SCB_SS1_HSIOM_MASK,
                                       GLCD_SPIM_SCB_SS1_HSIOM_POS, GLCD_SPIM_SCB_SS1_HSIOM_SEL_SPI);
        ...
        GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SS2_HSIOM_REG, GLCD_SPIM_SCB_SS2_HSIOM_MASK,
                                       GLCD_SPIM_SCB_SS2_HSIOM_POS, GLCD_SPIM_SCB_SS2_HSIOM_SEL_SPI);
        ...
        GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SS3_HSIOM_REG, GLCD_SPIM_SCB_SS3_HSIOM_MASK,
                                       GLCD_SPIM_SCB_SS3_HSIOM_POS, GLCD_SPIM_SCB_SS3_HSIOM_SEL_SPI);
        ...
        /* Set SCB SPI to drive output pin */
        GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SCLK_M_HSIOM_REG, GLCD_SPIM_SCB_SCLK_M_HSIOM_MASK,
                                       GLCD_SPIM_SCB_SCLK_M_HSIOM_POS, GLCD_SPIM_SCB_SCLK_M_HSIOM_SEL_SPI);
    #endif /* (GLCD_SPIM_SCB_MISO_SDA_TX_PIN_PIN) */

    #if (GLCD_SPIM_SCB_SPI_MASTER_SS0_PIN)
        /* Set SCB SPI to drive output pin */
        GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SS0_M_HSIOM_REG, GLCD_SPIM_SCB_SS0_M_HSIOM_MASK,
                                       GLCD_SPIM_SCB_SS0_M_HSIOM_POS, GLCD_SPIM_SCB_SS0_M_HSIOM_SEL_SPI);
    #endif /* (GLCD_SPIM_SCB_SPI_MASTER_SS0_PIN) */

    #if (GLCD_SPIM_SCB_SPI_MASTER_SS1_PIN)
        /* Set SCB SPI to drive output pin */
        GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SS1_M_HSIOM_REG, GLCD_SPIM_SCB_SS1_M_HSIOM_MASK,
                                       GLCD_SPIM_SCB_SS1_M_HSIOM_POS, GLCD_SPIM_SCB_SS1_M_HSIOM_SEL_SPI);
    #endif /* (GLCD_SPIM_SCB_SPI_MASTER_SS1_PIN) */

    #if (GLCD_SPIM_SCB_SPI_MASTER_SS2_PIN)
        /* Set SCB SPI to drive output pin */
        GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SS2_M_HSIOM_REG, GLCD_SPIM_SCB_SS2_M_HSIOM_MASK,
                                       GLCD_SPIM_SCB_SS2_M_HSIOM_POS, GLCD_SPIM_SCB_SS2_M_HSIOM_SEL_SPI);
    #endif /* (GLCD_SPIM_SCB_SPI_MASTER_SS2_PIN) */

    #if (GLCD_SPIM_SCB_SPI_MASTER_SS3_PIN)
        /* Set SCB SPI to drive output pin */
        GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SS3_M_HSIOM_REG, GLCD_SPIM_SCB_SS3_M_HSIOM_MASK,
                                       GLCD_SPIM_SCB_SS3_M_HSIOM_POS, GLCD_SPIM_SCB_SS3_M_HSIOM_SEL_SPI);
    #endif /* (GLCD_SPIM_SCB_SPI_MASTER_SS3_PIN) */

#endif /* (GLCD_SPIM_SCB_SCB_MODE_UNCONFIG_CONST_CFG) */

    /* Restore TX interrupt sources. */
    GLCD_SPIM_SCB_SetTxInterruptMode(GLCD_SPIM_SCB_IntrTxMask);
}


/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_SpiStop
****************************************************************************//**
*
...
void GLCD_SPIM_SCB_SpiStop(void)
{
    ...
    if (GLCD_SPIM_SCB_CHECK_SPI_MASTER)
    {
        ...
        GLCD_SPIM_SCB_spi_sclk_Write(GLCD_SPIM_SCB_GET_SPI_SCLK_INACTIVE);

        /* Set GPIO to drive output pin */
        GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SCLK_HSIOM_REG, GLCD_SPIM_SCB_SCLK_HSIOM_MASK,
                                       GLCD_SPIM_SCB_SCLK_HSIOM_POS, GLCD_SPIM_SCB_SCLK_HSIOM_SEL_GPIO);
    #endif /* (GLCD_SPIM_SCB_spi_sclk_PIN) */

    #if (GLCD_SPIM_SCB_SS0_PIN)
        /* Set output pin state after block is disabled */
        GLCD_SPIM_SCB_spi_ss0_Write(GLCD_SPIM_SCB_GET_SPI_SS0_INACTIVE);

        /* Set GPIO to drive output pin */
        GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SS0_HSIOM_REG, GLCD_SPIM_SCB_SS0_HSIOM_MASK,
                                       GLCD_SPIM_SCB_SS0_HSIOM_POS, GLCD_SPIM_SCB_SS0_HSIOM_SEL_GPIO);
    #endif /* (GLCD_SPIM_SCB_spi_ss0_PIN) */

    #if (GLCD_SPIM_SCB_SS1_PIN)
        /* Set output pin state after block is disabled */
        GLCD_SPIM_SCB_spi_ss1_Write(GLCD_SPIM_SCB_GET_SPI_SS1_INACTIVE);

        /* Set GPIO to drive output pin */
        GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SS1_HSIOM_REG, GLCD_SPIM_SCB_SS1_HSIOM_MASK,
                                       GLCD_SPIM_SCB_SS1_HSIOM_POS, GLCD_SPIM_SCB_SS1_HSIOM_SEL_GPIO);
    #endif /* (GLCD_SPIM_SCB_SS1_PIN) */

    #if (GLCD_SPIM_SCB_SS2_PIN)
        /* Set output pin state after block is disabled */
        GLCD_SPIM_SCB_spi_ss2_Write(GLCD_SPIM_SCB_GET_SPI_SS2_INACTIVE);

        /* Set GPIO to drive output pin */
        GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SS2_HSIOM_REG, GLCD_SPIM_SCB_SS2_HSIOM_MASK,
                                       GLCD_SPIM_SCB_SS2_HSIOM_POS, GLCD_SPIM_SCB_SS2_HSIOM_SEL_GPIO);
    #endif /* (GLCD_SPIM_SCB_SS2_PIN) */

    #if (GLCD_SPIM_SCB_SS3_PIN)
        /* Set output pin state after block is disabled */
        GLCD_SPIM_SCB_spi_ss3_Write(GLCD_SPIM_SCB_GET_SPI_SS3_INACTIVE);

        /* Set GPIO to drive output pin */
        GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SS3_HSIOM_REG, GLCD_SPIM_SCB_SS3_HSIOM_MASK,
                                       GLCD_SPIM_SCB_SS3_HSIOM_POS, GLCD_SPIM_SCB_SS3_HSIOM_SEL_GPIO);
    #endif /* (GLCD_SPIM_SCB_SS3_PIN) */
    
        /* Store TX interrupt sources (exclude level triggered) for master. */
        GLCD_SPIM_SCB_IntrTxMask = LO16(GLCD_SPIM_SCB_GetTxInterruptMode() & GLCD_SPIM_SCB_INTR_SPIM_TX_RESTORE);
    }
    else
    {
        /* Store TX interrupt sources (exclude level triggered) for slave. */
        GLCD_SPIM_SCB_IntrTxMask = LO16(GLCD_SPIM_SCB_GetTxInterruptMode() & GLCD_SPIM_SCB_INTR_SPIS_TX_RESTORE);
    }
...
#if (GLCD_SPIM_SCB_SPI_MASTER_SCLK_PIN)
    /* Set output pin state after block is disabled */
    GLCD_SPIM_SCB_sclk_m_Write(GLCD_SPIM_SCB_GET_SPI_SCLK_INACTIVE);

    /* Set GPIO to drive output pin */
    GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SCLK_M_HSIOM_REG, GLCD_SPIM_SCB_SCLK_M_HSIOM_MASK,
                                   GLCD_SPIM_SCB_SCLK_M_HSIOM_POS, GLCD_SPIM_SCB_SCLK_M_HSIOM_SEL_GPIO);
#endif /* (GLCD_SPIM_SCB_MISO_SDA_TX_PIN_PIN) */

#if (GLCD_SPIM_SCB_SPI_MASTER_SS0_PIN)
    /* Set output pin state after block is disabled */
    GLCD_SPIM_SCB_ss0_m_Write(GLCD_SPIM_SCB_GET_SPI_SS0_INACTIVE);

    /* Set GPIO to drive output pin */
    GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SS0_M_HSIOM_REG, GLCD_SPIM_SCB_SS0_M_HSIOM_MASK,
                                   GLCD_SPIM_SCB_SS0_M_HSIOM_POS, GLCD_SPIM_SCB_SS0_M_HSIOM_SEL_GPIO);
#endif /* (GLCD_SPIM_SCB_SPI_MASTER_SS0_PIN) */

#if (GLCD_SPIM_SCB_SPI_MASTER_SS1_PIN)
    /* Set output pin state after block is disabled */
    GLCD_SPIM_SCB_ss1_m_Write(GLCD_SPIM_SCB_GET_SPI_SS1_INACTIVE);

    /* Set GPIO to drive output pin */
    GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SS1_M_HSIOM_REG, GLCD_SPIM_SCB_SS1_M_HSIOM_MASK,
                                   GLCD_SPIM_SCB_SS1_M_HSIOM_POS, GLCD_SPIM_SCB_SS1_M_HSIOM_SEL_GPIO);
#endif /* (GLCD_SPIM_SCB_SPI_MASTER_SS1_PIN) */

#if (GLCD_SPIM_SCB_SPI_MASTER_SS2_PIN)
    /* Set output pin state after block is disabled */
    GLCD_SPIM_SCB_ss2_m_Write(GLCD_SPIM_SCB_GET_SPI_SS2_INACTIVE);

    /* Set GPIO to drive output pin */
    GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SS2_M_HSIOM_REG, GLCD_SPIM_SCB_SS2_M_HSIOM_MASK,
                                   GLCD_SPIM_SCB_SS2_M_HSIOM_POS, GLCD_SPIM_SCB_SS2_M_HSIOM_SEL_GPIO);
#endif /* (GLCD_SPIM_SCB_SPI_MASTER_SS2_PIN) */

#if (GLCD_SPIM_SCB_SPI_MASTER_SS3_PIN)
    /* Set output pin state after block is disabled */
    GLCD_SPIM_SCB_ss3_m_Write(GLCD_SPIM_SCB_GET_SPI_SS3_INACTIVE);

    /* Set GPIO to drive output pin */
    GLCD_SPIM_SCB_SET_HSIOM_SEL(GLCD_SPIM_SCB_SS3_M_HSIOM_REG, GLCD_SPIM_SCB_SS3_M_HSIOM_MASK,
                                   GLCD_SPIM_SCB_SS3_M_HSIOM_POS, GLCD_SPIM_SCB_SS3_M_HSIOM_SEL_GPIO);
#endif /* (GLCD_SPIM_SCB_SPI_MASTER_SS3_PIN) */
    ...
    *   transfer.
    *   - GLCD_SPIM_SCB_SPI_SLAVE_SELECT0 - Slave select 0.
    *   - GLCD_SPIM_SCB_SPI_SLAVE_SELECT1 - Slave select 1.
    *   - GLCD_SPIM_SCB_SPI_SLAVE_SELECT2 - Slave select 2.
    *   - GLCD_SPIM_SCB_SPI_SLAVE_SELECT3 - Slave select 3.
    *
    *******************************************************************************/
    void GLCD_SPIM_SCB_SpiSetActiveSlaveSelect(uint32 slaveSelect)
    {
        ...
        spiCtrl &= (uint32) ~GLCD_SPIM_SCB_SPI_CTRL_SLAVE_SELECT_MASK;
        spiCtrl |= (uint32)  GLCD_SPIM_SCB_GET_SPI_CTRL_SS(slaveSelect);
    ...
    /*******************************************************************************
    * Function Name: GLCD_SPIM_SCB_SpiSetSlaveSelectPolarity
    ****************************************************************************//**
    *
    ...
    *   - GLCD_SPIM_SCB_SPI_SS_ACTIVE_LOW  - Slave select is active low.
    *   - GLCD_SPIM_SCB_SPI_SS_ACTIVE_HIGH - Slave select is active high.
    *
    *******************************************************************************/
    void GLCD_SPIM_SCB_SpiSetSlaveSelectPolarity(uint32 slaveSelect, uint32 polarity)
    {
        ...
        ssPolarity = GLCD_SPIM_SCB_GET_SPI_CTRL_SSEL_POLARITY((uint32) 1u << slaveSelect);

        if (0u != polarity)
        {
            GLCD_SPIM_SCB_SPI_CTRL_REG |= (uint32)  ssPolarity;
        }
        else
        {
            GLCD_SPIM_SCB_SPI_CTRL_REG &= (uint32) ~ssPolarity;

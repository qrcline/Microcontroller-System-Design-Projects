...
#define Joystick_button_0_PS		(Joystick_button__0__PS)
#define Joystick_button_0_PC		(Joystick_button__0__PC)
#define Joystick_button_0_DR		(Joystick_button__0__DR)
#define Joystick_button_0_SHIFT	(Joystick_button__0__SHIFT)
#define Joystick_button_0_INTR	((uint16)((uint16)0x0003u << (Joystick_button__0__SHIFT*2u)))

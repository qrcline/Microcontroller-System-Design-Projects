// ======================================================================
// Clineq_Quinton_HW7.v generated from TopDesign.cysch
// 05/21/2019 at 22:07
...
module top ;
	...
	cy_clock_v1_0
		#(.id("6a1aa4cc-8768-4cbb-a36a-799080be3d4f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Tap_Input_net;
	wire [0:0] tmpIO_0__Tap_Input_net;
	wire [0:0] tmpINTERRUPT_0__Tap_Input_net;
	electrical [0:0] tmpSIOVREF__Tap_Input_net;

	cy_psoc3_pins_v1_10
		#(.id("857be706-b74e-482a-8761-77483071b626"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Tap_Input
		 (.oe(tmpOE__Tap_Input_net),
		  .y({1'b0}),
		  .fb({Net_70}),
		  .io({tmpIO_0__Tap_Input_net[0:0]}),
		  .siovref(tmpSIOVREF__Tap_Input_net),
		  .interrupt({tmpINTERRUPT_0__Tap_Input_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Tap_Input_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

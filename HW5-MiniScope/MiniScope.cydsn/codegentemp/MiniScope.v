// ======================================================================
// MiniScope.v generated from TopDesign.cysch
// 05/08/2019 at 13:33
...
module top ;
    ...
    ADC_SAR_SEQ_P4_v2_50_2 ADCInput (
        .Vref(Net_177),
        .sdone(Net_178),
        .eoc(Net_179),
        .aclk(1'b0),
	...
	cy_psoc3_pins_v1_10
		#(.id("09799b9c-db1d-48db-8c30-04efdde3beda"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),

...
static Stepper_Timer_BACKUP_STRUCT Stepper_Timer_backup;
...
{
    if(0u != (Stepper_Timer_BLOCK_CONTROL_REG & Stepper_Timer_MASK))
    {
        Stepper_Timer_backup.enableState = 1u;
    }
    else
    {
        Stepper_Timer_backup.enableState = 0u;
    }
...
void Stepper_Timer_Wakeup(void)
{
    ...
    if(0u != Stepper_Timer_backup.enableState)
    {
